<template>
  <div class="flex items-center gap-2">
    ...
    >
      <!-- Use the icon passed from parent, or fallback to default if not provided -->
      <span
        v-if="action.icon || !action.icon && getDefaultIcon(action.type)"
...
// Receive the array of actions as a prop
...
const defaultIcons = {
  ...
  primary: 'ri-star-line', // Default for primary
  secondary: 'ri-star-half-line', // Default for secondary
}
